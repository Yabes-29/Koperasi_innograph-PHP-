...
<html xmlns="http://koperasi_isg/xhtml">
<head>
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              if($_SESSION['level']=='admin')
              {
                ?>
                  ...
                  <p class="centered"><a href="#"><img src="logo.jpg" class="img-circle" width="60"></a></p>
            ...
            <li><a href="index.php?pilih=4.3"><i class="glyphicon glyphicon-user"></i> Setting User</a></li>
                  ...
                  <li class="sub-menu">
                      <a target="_blank" href="simulasi.php">
                          <i class="fa fa-bitcoin"></i>
                          <span style="font-size:120%; color:#fff;">Simulasi</span>
                      </a>
                  </li>
                  <li class="sub-menu">
