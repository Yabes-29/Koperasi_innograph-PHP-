...
<div class="form-group">
    <label>Bunga 1.5% / Lama Angsuran</label>
...
<label for="besar_angsur">Angsuran</label>
  ...
  value="<?php	
		$bunga=$jio['besar_pinjam'] * 0.015;	
		$lama_pinjam=$jio['lama_angsuran'];
		$angsuranke=$jio['sisa_angsuran']+1;
		
		//rumus angsuran 2 bulan
		if ($lama_pinjam == 2 && $angsuranke == 1) {
			echo ($jio['besar_pinjam'] / 2) + ("$bunga" * 1);
		} else if ($lama_pinjam == 2 && $angsuranke == 2) {
			echo ($jio['besar_pinjam'] / 2) + ("$bunga" / 2);
		
		//rumus angsuran 4 bulan
		} else if ($lama_pinjam == 4 && $angsuranke == 1) {
			echo ($jio['besar_pinjam'] / 4) + ("$bunga" * 1);
		} else if ($lama_pinjam == 4 && $angsuranke == 2) {
			echo ($jio['besar_pinjam'] / 4) + ("$bunga" * 1) - ("$bunga" / 4);
		} else if ($lama_pinjam == 4 && $angsuranke == 3) {
			echo ($jio['besar_pinjam'] / 4) + ("$bunga" / 2);
		} else if ($lama_pinjam == 4 && $angsuranke == 4) {
		echo ($jio['besar_pinjam'] / 4) + ("$bunga" / 4);

		//rumus angsuran 6 bulan
		} else if ($lama_pinjam == 6 && $angsuranke == 1) {
			echo ($jio['besar_pinjam'] / 6) + ("$bunga" * 1);
		} else if ($lama_pinjam == 6 && $angsuranke == 2) {
			echo ($jio['besar_pinjam'] / 6) + (("$bunga" / 6) * 5);
		} else if ($lama_pinjam == 6 && $angsuranke == 3) {
			echo ($jio['besar_pinjam'] / 6) + (("$bunga" / 6) * 4);
		} else if ($lama_pinjam == 6 && $angsuranke == 4) {
			echo ($jio['besar_pinjam'] / 6) + (("$bunga" / 6) * 3);
		} else if ($lama_pinjam == 6 && $angsuranke == 5) {
			echo ($jio['besar_pinjam'] / 6) + (("$bunga" / 6) * 2);
		} else if ($lama_pinjam == 6 && $angsuranke == 6) {
			echo ($jio['besar_pinjam'] / 6) + ("$bunga" / 6);

        //rumus angsuran 8 bulan
		} else if ($lama_pinjam == 8 && $angsuranke == 1) {
			echo ($jio['besar_pinjam'] / 8) + ("$bunga" * 1);
		} else if ($lama_pinjam == 8 && $angsuranke == 2) {
			echo ($jio['besar_pinjam'] / 8) + (("$bunga" / 8) * 7);
		} else if ($lama_pinjam == 8 && $angsuranke == 3) {
			echo ($jio['besar_pinjam'] / 8) + (("$bunga" / 8) * 6);
		} else if ($lama_pinjam == 8 && $angsuranke == 4) {
			echo ($jio['besar_pinjam'] / 8) + (("$bunga" / 8) * 5);
		} else if ($lama_pinjam == 8 && $angsuranke == 5) {
			echo ($jio['besar_pinjam'] / 8) + (("$bunga" / 8) * 4);
		} else if ($lama_pinjam == 8 && $angsuranke == 6) {
			echo ($jio['besar_pinjam'] / 8) + (("$bunga" / 8) * 3);
		} else if ($lama_pinjam == 8 && $angsuranke == 7) {
			echo ($jio['besar_pinjam'] / 8) + (("$bunga" / 8) * 2);
		} else if ($lama_pinjam == 8 && $angsuranke == 8) {
			echo ($jio['besar_pinjam'] / 8) + ("$bunga" / 8);

		//rumus angsuran 10 bulan
		} else if ($lama_pinjam == 10 && $angsuranke == 1) {
			echo ($jio['besar_pinjam'] / 10) + ("$bunga" * 1);
		} else if ($lama_pinjam == 10 && $angsuranke == 2) {
			echo ($jio['besar_pinjam'] / 10) + (("$bunga" / 10) * 9);
		} else if ($lama_pinjam == 10 && $angsuranke == 3) {
			echo ($jio['besar_pinjam'] / 10) + (("$bunga" / 10) * 8);
		} else if ($lama_pinjam == 10 && $angsuranke == 4) {
			echo ($jio['besar_pinjam'] / 10) + (("$bunga" / 10) * 7);
		} else if ($lama_pinjam == 10 && $angsuranke == 5) {
			echo ($jio['besar_pinjam'] / 10) + (("$bunga" / 10) * 6);
		} else if ($lama_pinjam == 10 && $angsuranke == 6) {
			echo ($jio['besar_pinjam'] / 10) + (("$bunga" / 10) * 5);
		} else if ($lama_pinjam == 10 && $angsuranke == 7) {
			echo ($jio['besar_pinjam'] / 10) + (("$bunga" / 10) * 4);
		} else if ($lama_pinjam == 10 && $angsuranke == 8) {
			echo ($jio['besar_pinjam'] / 10) + (("$bunga" / 10) * 3);
		} else if ($lama_pinjam == 10 && $angsuranke == 9) {
			echo ($jio['besar_pinjam'] / 10) + (("$bunga" / 10) * 2);
		} else if ($lama_pinjam == 10 && $angsuranke == 10) {
			echo ($jio['besar_pinjam'] / 10) + ("$bunga" / 10);	

			//rumus angsuran 12 bulan
		} else if ($lama_pinjam == 12 && $angsuranke == 1) {
			echo ($jio['besar_pinjam'] / 12) + ("$bunga" * 1);
		} else if ($lama_pinjam == 12 && $angsuranke == 2) {
			echo ($jio['besar_pinjam'] / 12) + (("$bunga" / 12) * 11);
		} else if ($lama_pinjam == 12 && $angsuranke == 3) {
			echo ($jio['besar_pinjam'] / 12) + (("$bunga" / 12) * 10);
		} else if ($lama_pinjam == 12 && $angsuranke == 4) {
			echo ($jio['besar_pinjam'] / 12) + (("$bunga" / 12) * 9);
		} else if ($lama_pinjam == 12 && $angsuranke == 5) {
			echo ($jio['besar_pinjam'] / 12) + (("$bunga" / 12) * 8);
		} else if ($lama_pinjam == 12 && $angsuranke == 6) {
			echo ($jio['besar_pinjam'] / 12) + (("$bunga" / 12) * 7);
		} else if ($lama_pinjam == 12 && $angsuranke == 7) {
			echo ($jio['besar_pinjam'] / 12) + (("$bunga" / 12) * 6);
		} else if ($lama_pinjam == 12 && $angsuranke == 8) {
			echo ($jio['besar_pinjam'] / 12) + (("$bunga" / 12) * 5);
		} else if ($lama_pinjam == 12 && $angsuranke == 9) {
			echo ($jio['besar_pinjam'] / 12) + (("$bunga" / 12) * 4);
		} else if ($lama_pinjam == 12 && $angsuranke == 10) {
			echo ($jio['besar_pinjam'] / 12) + (("$bunga" / 12) * 3);
		} else if ($lama_pinjam == 12 && $angsuranke == 11) {
			echo ($jio['besar_pinjam'] / 12) + (("$bunga" / 12) * 2);
		} else if ($lama_pinjam == 12 && $angsuranke == 12) {
			echo ($jio['besar_pinjam'] / 12) + ("$bunga" / 12);	

		} else {
			echo 'salah';
		}
	?>" id="besar_angsuran" size="54" />
</div>
<div class="form-group">
